...
3. **Find the human glue.** The nudges, the "can you look at this", the person who notices
   ...
   it down as steps and escalations; it is usually where flow-driven adds the most.
...
- `skills/flow-driven/references/ingest-recipes.md` — the per-tool mappings.
- `skills/flow-driven/references/workflow-definition.md` — the target schema.
- `skills/flow-driven/references/integration-adapters.md` — choosing the system of record next.
- Next: `flow-driven-scaffold` to materialise, or `flow-driven-define` to rework the graph.
