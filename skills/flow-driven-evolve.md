...
1. **Load the probe library**: `skills/flow-driven/references/loop-probes.md`.
...
- **Shrinking the machinery is a legitimate bet.** If cycles keep firing the low-priority rules
...
- `skills/flow-driven/references/loop-probes.md` — the four probe families.
- `skills/flow-driven/references/evolution-path.md` — stages, human roles, the platform play.
- `skills/flow-driven/references/measurement.md` — reading the numbers honestly.
- `skills/flow-driven/templates/improvement.md` — the bet card.
