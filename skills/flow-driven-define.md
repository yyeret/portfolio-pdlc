...
|---|---|---|
| A formal artefact — spec-kit, Kiro, a bespoke harness, a tracker with states | **Adapt** | Load `flow-driven-ingest` first, then return here for what the artefact does not cover: exits, delegation, decisions, and the human glue |
...
9. **Measures and system of record.** Name what you steer on and where the work lives. Route
   to `flow-driven-instrument` and `flow-driven-integrate`; do not improvise either.
...
- `skills/flow-driven/references/discovery-interview.md` — the interview ladder, what to
  listen for, and archetype matching.
- `skills/flow-driven/references/first-principles.md` — why work this way, the seven-question
...
- `skills/flow-driven/references/workflow-definition.md` — the schema this produces.
- `skills/flow-driven/references/step-contracts.md` — delegation ladder, run models, exit evidence.
- `skills/flow-driven/references/workflow-archetypes.md` — starting points and their tells.
- Next: `flow-driven-scaffold` to materialise it; `flow-driven-instrument` for measures.
