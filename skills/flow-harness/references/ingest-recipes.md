...
items — no WIP, no aging, no decision points, no measurement. That is exactly the gap this
harness fills, so keep spec-kit for the item and add the flow around it. Its
