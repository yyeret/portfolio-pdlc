...
Probes for `flow-harness-evolve`. Each names a signal in real workspace data, a reading, and
...
much machinery. Shrinking the harness is a legitimate improvement bet — and one nobody
