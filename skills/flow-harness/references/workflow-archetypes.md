...
The harness is workflow-agnostic. These archetypes exist so you do not start from a blank
...
the harness will make that embarrassingly visible, which is the point.
