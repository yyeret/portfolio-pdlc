...
Two families of stream are worth the harness:
...
Once you have picked: `flow-harness-define` runs the systems read that turns the stream
...
`flow-harness-ingest` instead, and map what exists before proposing anything.
