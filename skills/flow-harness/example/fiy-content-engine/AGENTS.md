...
This folder is a **flow workspace** run on the `flow-harness` operating system. `<REPO>`
...
```bash
python3 <REPO>/skills/flow-harness/scripts/flow_lint.py .  --today 2026-08-19
python3 <REPO>/skills/flow-harness/scripts/flow_board.py . --today 2026-08-19
python3 <REPO>/skills/flow-harness/scripts/flow_next.py .  --today 2026-08-19
```

3. Load `<REPO>/skills/flow-harness.md` and run one cycle.
