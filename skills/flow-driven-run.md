...
4. **Sanity-check the selection, do not shop for a better one.** The rule ordering encodes
   ...
   `flow-driven-evolve`, not a licence to pick your favourite item.
...
- `skills/flow-driven/references/loop-engineering.md` — the six beats and why the leverage
  table is ordered the way it is.
- `skills/flow-driven/references/step-contracts.md` — running a step, escalation, verification.
- `skills/flow-driven/references/workflow-definition.md` — what to record and where.
- `flow-driven-evolve` — where a wrong run card, a missing check, or a recurring escalation goes.
