...
- `skills/flow-harness/references/integration-adapters.md` — modes, the GitHub/Jira/dashboard
  recipes, the export payload, the five sync rules.
- `skills/flow-harness/templates/integrations.md` — the file this produces.
- `skills/flow-harness/example/fiy-content-engine/integrations.md` — a filled-in mirror-mode example.
